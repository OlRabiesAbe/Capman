...
///=====INIT
///================
_spriteArray = [spr_enemy_zombie_crosser_left, spr_enemy_zombie_crosser_up, 
					 spr_enemy_zombie_crosser_right, spr_enemy_zombie_crosser_right, spr_enemy_zombie_lit];
